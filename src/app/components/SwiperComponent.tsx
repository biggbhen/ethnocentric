							...
							<SwiperSlide key={index}>
								<div className='flex flex-col justify-between bg-white rounded-b-xl shadow-md h-[400px] space-y-4'>
									...
									<div className='border-t-0 border border-[#E0E0E0] w-full p-5 flex-grow rounded-b-xl space-y-2'>
										...
										<p className='text-swiper-gray text-sm'>
											{slide.description}
										</p>
										{slide.extraText && (
											<p className='text-sm text-[#FFA929] font-medium flex items-center cursor-pointer hover:underline w-fit'>
												{slide.extraText} <GoArrowUpRight />
											</p>
										)}
										{slide.extraTextEnd && (
											<p className='text-sm text-[#FFA929] font-medium flex items-center cursor-pointer hover:underline w-fit'>
