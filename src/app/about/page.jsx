			...
			<div className='flex flex-col gap-4 bg-white p-6 md:p-10'>
				...
				<div className='w-full md:w-[90%] mx-auto'>
					<motion.p
						...
						transition={{ duration: 0.6, ease: "easeOut" }}
						viewport={{ once: true, amount: 0.2 }}
						className='text-start mt-4 font-normal text-base md:text-lg'>
					...
					<div className='w-full lg:md:w-1/2 p-6 md:p-10 flex flex-col justify-center'>
						<div className='flex justify-center gap-4'>
							<motion.h2
								...
								transition={{ duration: 0.6, ease: "easeOut" }}
								viewport={{ once: true, amount: 0.2 }}
								className='font-medium py-4 md:py-7 text-2xl md:text-4xl max-w-full md:max-w-[90%] text-[#1A1A1A]'>
				...
				<ImageBackground
					...
					<div className='text-white text-center px-4 py-8 max-w-full md:max-w-[35rem]'>
						<motion.h2
							...
							transition={{ duration: 0.6, ease: "easeOut" }}
							viewport={{ once: true, amount: 0.2 }}
							className='font-medium py-4 md:py-7 text-2xl md:text-4xl max-w-full md:max-w-[90%]'>
							Contact Us
						</motion.h2>
						<motion.div
							initial={{ opacity: 0, y: 50 }}
